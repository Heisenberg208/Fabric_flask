...
OUTPUT_FOLDER = r"C:\Users\poorn\Downloads\lancedb-main\lancedb-main\output"
...
def index():
    if request.method == "POST":
        ...
        # Run vector search
        run_vector_search("~/.lancedb", table_name, Myntra, search_query, limit, app.config["OUTPUT_FOLDER"])
